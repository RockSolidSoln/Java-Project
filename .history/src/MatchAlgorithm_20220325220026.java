...
public class MatchAlgorithm {
    ...
    public static void runAlgo(String name, ArrayList<String> dName,                //takes paramater of aids name, donor's list
                                ArrayList<String> dAids ,ArrayList<Integer> dQty,   // and NGO's  
