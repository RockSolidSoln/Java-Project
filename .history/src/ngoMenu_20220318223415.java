...
public class ngoMenu {
    ...
    public static void viewAidsHistory(String name){
        ...
        try{
            ...
            do{
                ...
                if (list.contains(name) && list.contains("unsatsified")){
                    System.out.printf(list);
                }
                System.out.println();
    ...
    //-------------------------------------------------------------------------------------------//
    public static void directBack(String name){
        System.out.println(
        ("\n|------------------------------------------------------------|"
        +"\n                    NGO "+name+ "                             "
        +"\n|------------------------------------------------------------|"
        +"\n|   Enter 1: To go back to Ngo Menu                          |"
        +"\n|   Enter 2: To logout                                       |"
        +"\n|------------------------------------------------------------|");
        ...
        if (choice == 1) {
            ...
            System.out.println("Thanks for putting your requests,"
                                +);
        }
    }
}
