...
public class matching {
    ...
    private static ArrayList<String> requiredaids() throws IOException{
        ...
        return required;
        private static HashMap<String, HashMap<String, String>> getHash() throws IOException{
            HashMap<String, HashMap<String, String>> required = new HashMap<String,HashMap<String, String>;
