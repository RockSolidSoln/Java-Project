...
public class Ngo {
    ...
    public void saveNgoDemands() throws IOException{
        ...
        ArrayList<String> nAids = new ArrayList<String>();       //ArrayList stores all the name 
        ArrayList<Integer> nQty = new ArrayList<Integer>();      //ArrayList stores all the name 
        ArrayList<String> nStatus = new ArrayList<String>();      //ArrayList stores all the name 
        int flag=0;
