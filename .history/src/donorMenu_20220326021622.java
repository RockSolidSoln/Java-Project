...
public class DonorMenu {
    ...
    switch (choice){
        case(1):    enterAids(sc, name);      //re-routes to the enter aids method.
                    break;
        case(2):    showAvailableAids(sc, name,0); //show the aids still in DC
                    break;    
   ...
   //-----------------------Allows User to enter aids to donate along with donor info-------------//
    ...
    //-------------------------------------------------------------------------------------------//
    public static void showAvailableAids(Scanner input, String name,int flag){    // takes the name of the Donor and flag
