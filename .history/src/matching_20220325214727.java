...
public class Matching{  
    ...
    public static void filter() throws IOException{
        ...
        //these array lists are to store filtered donors aids accordingly
        ...
        //these array lists are to store left over donor aids not to be matched in this iteration
        ArrayList<String> fName = new ArrayList<String>();
        ArrayList<String> fAids = new ArrayList<String>();
        ArrayList<Integer> fQty = new ArrayList<Integer>();

        //these array lists are to store NGO requ
