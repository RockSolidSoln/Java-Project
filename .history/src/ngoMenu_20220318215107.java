...
public class ngoMenu {
    ...
    public static void welcomeNgo(String name) throws IOException {
        ...
        +"\n|      Enter 2: To view if unsatisfied aids                  |" // i think option 2 belongs in DC
        +"\n|      Enter 3: To view history of  satisfiedaids             |" // done this and ngo is ready for improvements 
        +"\n|------------------------------------------------------------|");
