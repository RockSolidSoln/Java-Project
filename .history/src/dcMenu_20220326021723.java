...
public class DcMenu {
    ...
    public static void showDcMenu(Scanner sc) throws IOException {
        System.out.println
        ("\n|---------------------------------------------------------------|"
        ...
        switch (choice) {
            case 1:     DonorMenu.showAvailableAids(sc, "null",1);  //show all the available aids in the list
                        break;
            case 2:     NgoMenu.showStatus(sc, "null",1);           //show all the requested aids in the system
                        break;
        ...
        DirectBackMenu.directBack("null",3);
    }
    //-------------------------------------------------------------------------------------------//
