...
public class WriteBack {
    ...
    public static void updateDonor(ArrayList<String> dName, ArrayList<String> dAids,
        ...
        if(flag==0){    //if flag 0 means do not truncate the array and re write it again
        ...
        else{       //if flag not 0 means appending after every set of values
    ...
    public static void updateNgo(ArrayList<String> nName,
        ...
        try{
            ...
            FileWriter fw = new FileWriter(path,true);      //truncate the file
            fw.write(nName.get(0) +","+ nAids.get(0)+ "," + nQty.get(0)+","+ nStatus.get(0));   //appends 
