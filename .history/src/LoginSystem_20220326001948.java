...
public class LoginSystem {
    ...
    public static void authenticateUser(int flag) throws IOException, NoSuchMethodException{// flag is to check if user is Donor or Ngo
        ...
        if(check==false){               // if name or password doesn't match
            System.out.println("---------------------------------------------\n"+
                               ...
                               "   Try again\n"+
                               "---------------------------------------------\n");
            authenticateUser(flag);     // directs user to try again.
        } 
    }
    //------------------------------------------------------------------------------------
