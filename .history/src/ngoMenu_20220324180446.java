...
public class ngoMenu {
    ...
    public static void showStatus(String name, int flag){
        ...
        try{
            ...
            System.out.println("\n|------------------------------------------------------------------------|");
            System.out.format("|%10s  |%11s |%10s |%10s ","Name ","Aid","Quantity","Status"); //template for the table.
            System.out.println("\n|------------------------------------------------------------------------|");
            do{
                ...
                if (list.contains(name) && list.contains("unsatsified") && flag==0){
                    ...
                    System.out.printf("| %10s |%11s |%10s |%10s ",temp[0],temp[1],temp[2],temp[3]);
                    System.out.print("\n|------------------------------------------------------------------------|");
                }
                else if(flag==1){
                    String[] temp = list.split("\\s+");
                    System.out.printf("| %10s |%11s |%10s |%10s ",temp[0],temp[1],temp[2],temp[3],temp[4],temp[5]);
                    System.out.print("\n|------------------------------------------------------------------------|");
                }
                System.out.println();
