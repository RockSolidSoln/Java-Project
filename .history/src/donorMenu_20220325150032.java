...
public class DonorMenu {
   ...
   //-----------------------Allows User to enter aids to donate along with donor info-------------//
    ...
    //-------------------------------------------------------------------------------------------//
    public static void showStatus(String name,int flag){    // takes the name of the Donor and flag
        ...
        try{
            ...
            do{
                ...
                if (list.contains(name) && flag==0){     // if the list containes the name of the Donotr
