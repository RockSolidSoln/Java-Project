...
public class Donor{
    ...
    public static ArrayList<String> donatedaids() throws IOException{
        ArrayList<String> previous= new ArrayList<>();     //to store all the donated aids lists
        ...
        for(int i =0; i<lines.size();i++){
            ...
            required.add(Name+" "+aids+" "+quantity);  //stores every thing in the array
        }
        return required;                                //return the array
    }
    //-------------------------------------------------------------------------------------------//
}