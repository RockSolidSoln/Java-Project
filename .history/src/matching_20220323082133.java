...
public class matching{  
    ...
    public static String getNgoName(ArrayList<String> name, ArrayList<String> aids, ArrayList<Integer> qty, ArrayList<String> status){
        for(int i=0; i<name.size();i++){
            System.out.println(name.get(i) + " " + aids.get(i) + " " + qty.get(i) + " " + statusget(i))); 
        }
