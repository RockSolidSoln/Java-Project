...
public class LoginSystem {
    ...
    private static void saveCredsToFile(int flag, String name, String password) throws IOException {
        StringBuilder sb = new StringBuilder();
        if(flag==1){
            Files.write(Paths.get("src/credentials.csv"),name+","+password,.getBytes()))
        }
        else if(flag==2){
