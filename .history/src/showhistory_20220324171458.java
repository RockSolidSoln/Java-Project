        ...
        try{
            ...
            do{
                ...
                if (list.contains(name) && flag==0){
                    ...
                    System.out.format("%10s %15s %15s %10s %10s %10s",temp[0],temp[1],temp[2],temp[3],temp[4],temp[5]);
                
                    //System.out.printf(list); //to print just the data of named entity
                }
                else if(flag==1){
                    String[] temp = list.split("\\s");
                    System.out.format("%10s %10s %15s %10s %10s %10s",temp[0],temp[1],temp[2],temp[3],temp[4],temp[5]);
