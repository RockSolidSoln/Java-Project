...
public class WriteBack {
    ...
    public static void store(String dName, String dAids ,int dQty, String nName) throws IOException{ //takes the Donors as well as NGO's info
        ...
        List<String> lines = Files.readAllLines(Paths.get("src/credentials/DonorCredentials.csv"));  //read from the file and store in the Strings Arraylist
        ...
        try (FileWriter fw = new FileWriter(path,true);){
            ...
            System.out.println("\n|------------------------------------------------------------------------|");
            System.out.printf("| %10s |%11s |%10s |%10s |%10s |%10s|",dName, phono, dAids, dQty, nName, manpower);
            System.out.println("\n|------------------------------------------------------------------------|");
        } catch(Exception e){
